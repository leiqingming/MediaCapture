...
public class FixedTextureVideoView extends TextureView
    ...
    void initControllerView(Context context){
        //mController = new VideoControllerView(context);
        //mVideoPopupWindow = new SelectVideoPopupWindow(context);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(TAG, String.format
                ("onMeasure, fixedWidth = %d , fixedHeight = %d", fixedWidth, fixedHeight));
    }

    public void defaultMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(TAG,"defaultMeasure: width = "+width+" ,height = "+height);
...
//                    }
    ...
    final MediaPlayer.OnPreparedListener mPreparedListener = new MediaPlayer.OnPreparedListener() {
        public void onPrepared(MediaPlayer mp) {
            ...
            //修改
            SplitScreenActivity.getInstance().endTime.setText(secToTime(getDuration() / 1000));
            SplitScreenActivity.getInstance().mSeekBar.setMax(getDuration());
            SplitScreenActivity.getInstance().mSeekBar.setProgress(getCurrentPosition());
    ...
    private OnCompletionListener mCompletionListener =
            new OnCompletionListener() {
                public void onCompletion(MediaPlayer mp) {
                    ...
                    SelectVideoPopupWindow.playNextPath();
