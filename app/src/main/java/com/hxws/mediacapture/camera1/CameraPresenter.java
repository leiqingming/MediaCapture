...
import com.hxws.mediacapture.utils.Configuration;
import com.hxws.mediacapture.utils.SystemUtil;
import com.hxws.mediacapture.utils.ThreadPoolUtil;
import com.hxws.mediacapture.utils.ToastUtil;
...
public class CameraPresenter implements Camera.PreviewCallback {
    ...
    public final static String TAG = "CameraPresenter";
    ...
    FixedTextureCameraView mFixedTextureCameraView;
    ...
    public CameraPresenter(Fragment fragment, SurfaceView mSurfaceView) {
    ...
    public CameraPresenter(Fragment fragment, FixedTextureCameraView fixedTextureCameraView) {
        this.mActivity = fragment.getActivity();
        this.mFixedTextureCameraView = fixedTextureCameraView;
        //  mSurfaceView.getHolder().setKeepScreenOn(true);

        mFixedTextureCameraView.getSurfaceTexture();
...
//        });
    ...
    private boolean openCamera(int FaceOrBack) {
        ...
        //Log.d("openCamera: ","isSupportCamera: "+isSupportCamera);
        ...
        //if (isSupportCamera) {
            try {
                ...
                ToastUtil.showShortToast(mActivity, "打开相机失败~");
                return false;
            }
...
//        int h = mSurfaceView.getHeight();
        ...
        int w = mFixedTextureCameraView.getWidth();
        int h = mFixedTextureCameraView.getHeight();
...
//    }
    ...
    private boolean isSupport(int faceOrBack) {
        ...
        Log.d("isSupport: ","faceOrBack: "+faceOrBack);
        Camera.CameraInfo cameraInfo = new Camera.CameraInfo();
        for (int i = 0; i < Camera.getNumberOfCameras(); i++) {
            //返回相机信息
            Camera.getCameraInfo(i, cameraInfo);

            Log.d("isSupport: ","cameraInfo.facing: "+cameraInfo.facing);
    ...
    private void startPreview() {
        ...
        try {
            ...
            mSurfaceTexture = mFixedTextureCameraView.getSurfaceTexture();
...
//        });
    ...
    public void switchCamera() {
        //先释放资源
        releaseCamera();
        //在Android P之前 Android设备仍然最多只有前后两个摄像头，
        // 在Android p后支持多个摄像头 用户想打开哪个就打开哪个.
        ...
        Log.d("switchCamera",
                "Camera.getNumberOfCameras(): "+Camera.getNumberOfCameras());
        Log.d("switchCamera",
                "mCameraId: "+mCameraId);
        //打开摄像头
        openCamera(mCameraId);
        ...
        ThreadPoolUtil.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    SystemUtil.saveAlbum(Configuration.insidePath + file.getName(), file.getName(), mActivity);
                    //将图片复制到外部
